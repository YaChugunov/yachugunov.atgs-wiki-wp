  ...
  <div class="ht-container">
    ...
    <section id="content" role="main">
      ...
      <header id="page-header">
        <h2 class="page-title">
          <?php _e('Article Categories1', 'knowhow') ?>
        </h2>
      </header>
      <div id="homepage-categories" class="clearfix">
        ...
        if ($st_categories) {
          foreach ($st_categories as $st_category) {
            ...
            //List Posts
            $st_cat_post_num = apply_filters('knowhow_get_theme_option', 'st_hp_cat_postnum', '5');
            $st_posts_order = apply_filters('knowhow_get_theme_option', 'st_hp_cat_posts_order', null);
