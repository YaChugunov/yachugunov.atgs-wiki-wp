...
/*-----------------------------------------------------------------------------------*/
	...
	public function __construct() {
		...
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'st_articles_widget', 'description' => __('A widget that displays your latest articles', 'knowhow') );

		/* Widget control settings. */
		$control_ops = array( 'id_base' => 'st_articles_widget' );

		/* Create the widget. */
		parent::__construct( 'st_articles_widget', __('Latest Articles Widget', 'knowhow'), $widget_ops, $control_ops );
	}
