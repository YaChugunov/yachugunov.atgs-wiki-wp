...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'knowhow' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'knowhow' ),
		'repeat-y'  => __( 'Repeat Vertically', 'knowhow' ),
		'repeat'    => __( 'Repeat All', 'knowhow' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'knowhow' ),
		'top center'    => __( 'Top Center', 'knowhow' ),
		'top right'     => __( 'Top Right', 'knowhow' ),
		'center left'   => __( 'Middle Left', 'knowhow' ),
		'center center' => __( 'Middle Center', 'knowhow' ),
		'center right'  => __( 'Middle Right', 'knowhow' ),
		'bottom left'   => __( 'Bottom Left', 'knowhow' ),
		'bottom center' => __( 'Bottom Center', 'knowhow' ),
		'bottom right'  => __( 'Bottom Right', 'knowhow')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'knowhow' ),
		'fixed'  => __( 'Fixed in Place', 'knowhow')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'knowhow' ),
		'italic'      => __( 'Italic', 'knowhow' ),
		'bold'        => __( 'Bold', 'knowhow' ),
		'bold italic' => __( 'Bold Italic', 'knowhow' )
		);
