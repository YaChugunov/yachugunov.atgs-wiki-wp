...
function st_shortcode_styles() {
  wp_enqueue_style( 'shortcodes-css', plugin_dir_url( __FILE__ ) . '/shortcodes.css' );
}
add_action( 'wp_enqueue_scripts', 'st_shortcode_styles' );

function st_shortcode_scripts() {
  wp_enqueue_script( 'shortcodes-js', plugin_dir_url( __FILE__ ) . '/shortcodes.js', array( 'jquery' ), false, true );
}
add_action( 'wp_enqueue_scripts', 'st_shortcode_scripts' );
